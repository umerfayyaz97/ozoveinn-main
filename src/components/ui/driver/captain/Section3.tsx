...
const Section3 = () => {
  return (
    <div className="bg-graish text-white lg:h-[540px] lg:px-20 p-8 ">
      <Head>
      ...
      <div className="lg:flex  justify-between">
        <div className="lg:w-2/4 justify-center text-start items-start flex flex-col  lg:p-14  ">
          <p className="text-3xl font-bold mb-4">
            ...
            <span className="text-customYellow mt-6">With Oz Ove</span>{" "}
          </p>
          <p className="text-base mb-8">
            ...
            Captain with OZ Ove, you&apos;ll receive access to our fleet of
